...
var redis = new Redis();
var cache = false;
var crawler = require('./favicon-crawler');
var app = express();
...
var usage = function() {
  'use strict';
  return 'Welcome to Favicon-Crawler.<br/>&nbsp;&nbsp;Usage /get?domain=google.com';
};

// find icon function
var findFavIcon = function(domain, res) {
  crawler.findFavIcon(domain, function(response) {
